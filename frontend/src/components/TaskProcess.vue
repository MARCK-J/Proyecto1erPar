<template>
    <div>
      ...
      <div class="container mt-5">
        <h2 class="text-center mb-4">Tareas en Proceso</h2>
        ...
        try {
          ...
          if (userId) {
            ...
            for (const etiqueta of etiquetas) {
              ...
              const processTasks = tasksResponse.data.result.filter(task => task.estado === 'En proceso');
              this.tasks.push(...processTasks);
            }
